      ...
      {step === 2 && (
        <div className="create-card fade-in">
          ...
          <div className="create-qt-section">
            <label className="create-form-label create-form-label-bold" style={{ marginBottom: '16px' }}>Question Type</label>

            {formData.questionTypes.map((qt, i) => (
              <div key={i} className="create-qt-card">
                <div className="create-qt-card-header">
                  <div className="create-qt-select-wrap">
                    <select className="create-qt-card-select" value={qt.type}
                    ...
                    <svg className="create-qt-card-chevron" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><polyline points="6 9 12 15 18 9"/></svg>
                  </div>
                  {formData.questionTypes.length > 1 ? (
                    <button type="button" className="create-qt-card-remove" onClick={() => removeQuestionType(i)}>
                ...
                <div className="create-qt-card-body">
                  <div className="create-qt-card-col">
                    <span className="create-qt-card-label">No. of Questions</span>
                  ...
                  <div className="create-qt-card-col">
                    <span className="create-qt-card-label">Marks</span>
                    <div className="create-qt-counter">
            ...
            <button type="button" className="create-qt-add" onClick={addQuestionType}>
              <span className="create-qt-add-icon">
